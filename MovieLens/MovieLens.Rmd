...
```{r ml-pipeline-diagram-no-bars, echo=FALSE, message=FALSE, warning=FALSE, fig.align='center', fig.height=16, fig.width=24}
# Load the necessary library
library(DiagrammeR)

# Store your DOT language code in an R string variable
# The horizontal separator bars have been removed from all nodes.
ml_pipeline_dot <- "
digraph G {
  ...
  graph [
    ...
    fontname='Helvetica';
    fontsize=20;
    label='Machine Learning Pipeline for Recommender Systems';
    labelloc=t;
    bgcolor='#F5F5F5';
  ];
  ...
  subgraph cluster_data {
    label=<<FONT POINT-SIZE='36'><B><BR/>Data Prep &amp; EDA</B></FONT>>;
    ...
    wrangling [fillcolor='#E3F2FD', label=< <TABLE BORDER='0' CELLBORDER='0' CELLSPACING='0' CELLPADDING='12'> <TR><TD ALIGN='CENTER'><B><FONT POINT-SIZE='24'>1. Data Wrangling</FONT></B></TD></TR> <TR><TD ALIGN='LEFT' BALIGN='LEFT'><FONT POINT-SIZE='20'> • Merge datasets<br/> • Handle missing values<br/> • Check data types<br/> • Remove duplicates </FONT></TD></TR> </TABLE> >];
    audit [fillcolor='#E3F2FD', label=< <TABLE BORDER='0' CELLBORDER='0' CELLSPACING='0' CELLPADDING='12'> <TR><TD ALIGN='CENTER'><B><FONT POINT-SIZE='24'>2. Data Audit</FONT></B></TD></TR> <TR><TD ALIGN='LEFT' BALIGN='LEFT'><FONT POINT-SIZE='20'> • Summary statistics<br/> • Distribution plots<br/> • Identify outliers<br/> • Data validation </FONT></TD></TR> </TABLE> >];
    trends [fillcolor='#E1F5FE', label=< <TABLE BORDER='0' CELLBORDER='0' CELLSPACING='0' CELLPADDING='12'> <TR><TD ALIGN='CENTER'><B><FONT POINT-SIZE='24'>3. Trends Analysis</FONT></B></TD></TR> <TR><TD ALIGN='LEFT' BALIGN='LEFT'><FONT POINT-SIZE='20'> • Top items/users<br/> • Ratings over time<br/> • Genre popularity<br/> • User activity levels </FONT></TD></TR> </TABLE> >];
    featprep [fillcolor='#E1F5FE', label=< <TABLE BORDER='0' CELLBORDER='0' CELLSPACING='0' CELLPADDING='12'> <TR><TD ALIGN='CENTER'><B><FONT POINT-SIZE='24'>4. Feature Engineering</FONT></B></TD></TR> <TR><TD ALIGN='LEFT' BALIGN='LEFT'><FONT POINT-SIZE='20'> • Time features<br/> • Normalize ratings<br/> • Encode genres<br/> • Activity bins<br/> • Tag outliers </FONT></TD></TR> </TABLE> >];
  ...
  subgraph cluster_modeling {
    label=<<FONT POINT-SIZE='36'><B><BR/>Model Development &amp; Evaluation</B></FONT>>;
    style='filled,rounded';
    color='#9575CD';
    fillcolor='#D1C4E9';
    margin=30;
    ...
    modelsel [fillcolor='#EDE7F6', label=< <TABLE BORDER='0' CELLBORDER='0' CELLSPACING='0' CELLPADDING='12'> <TR><TD ALIGN='CENTER'><B><FONT POINT-SIZE='24'>5. Model Selection</FONT></B></TD></TR> <TR><TD ALIGN='LEFT' BALIGN='LEFT'><FONT POINT-SIZE='20'> • Identify ≥4 models<br/> • List key features<br/> • Core assumptions<br/> • Justify choices </FONT></TD></TR> </TABLE>>];
    prepfe [fillcolor='#EDE7F6', label=< <TABLE BORDER='0' CELLBORDER='0' CELLSPACING='0' CELLPADDING='12'> <TR><TD ALIGN='CENTER'><B><FONT POINT-SIZE='24'>6. Data Prep &amp; FE</FONT></B></TD></TR> <TR><TD ALIGN='LEFT' BALIGN='LEFT'><FONT POINT-SIZE='20'> • Preprocessing<br/> • Feature engineering<br/> • Handle sparsity<br/> • Train/test splits </FONT></TD></TR> </TABLE>>];
    train [fillcolor='#EDE7F6', label=< <TABLE BORDER='0' CELLBORDER='0' CELLSPACING='0' CELLPADDING='12'> <TR><TD ALIGN='CENTER'><B><FONT POINT-SIZE='24'>7. Train &amp; Tune</FONT></B></TD></TR> <TR><TD ALIGN='LEFT' BALIGN='LEFT'><FONT POINT-SIZE='20'> • Train models<br/> • Cross-validation<br/> • Log metrics<br/> • Hyperparameter search </FONT></TD></TR> </TABLE>>];
    reg [fillcolor='#EDE7F6', label=< <TABLE BORDER='0' CELLBORDER='0' CELLSPACING='0' CELLPADDING='12'> <TR><TD ALIGN='CENTER'><B><FONT POINT-SIZE='24'>8. Regularization</FONT></B></TD></TR> <TR><TD ALIGN='LEFT' BALIGN='LEFT'><FONT POINT-SIZE='20'> • Avoid overfitting<br/> • Compare baseline<br/> • Complexity effects<br/> • L1/L2/Dropout </FONT></TD></TR> </TABLE>>];
    eval [fillcolor='#EDE7F6', label=< <TABLE BORDER='0' CELLBORDER='0' CELLSPACING='0' CELLPADDING='12'> <TR><TD ALIGN='CENTER'><B><FONT POINT-SIZE='24'>9. Evaluation</FONT></B></TD></TR> <TR><TD ALIGN='LEFT' BALIGN='LEFT'><FONT POINT-SIZE='20'> • RMSE/MAE<br/> • Ranking metrics<br/> • Comparison table<br/> • Significance tests </FONT></TD></TR> </TABLE>>];
    ens [fillcolor='#EDE7F6', label=< <TABLE BORDER='0' CELLBORDER='0' CELLSPACING='0' CELLPADDING='12'> <TR><TD ALIGN='CENTER'><B><FONT POINT-SIZE='24'>10. Ensemble</FONT></B></TD></TR> <TR><TD ALIGN='LEFT' BALIGN='LEFT'><FONT POINT-SIZE='20'> • Stacking/blending<br/> • Compare models<br/> • Record trade-offs<br/> • Complexity </FONT></TD></TR> </TABLE>>];
    report [fillcolor='#EDE7F6', label=< <TABLE BORDER='0' CELLBORDER='0' CELLSPACING='0' CELLPADDING='12'> <TR><TD ALIGN='CENTER'><B><FONT POINT-SIZE='24'>11. Reporting</FONT></B></TD></TR> <TR><TD ALIGN='LEFT' BALIGN='LEFT'><FONT POINT-SIZE='20'> • Parameters<br/> • Visuals/stats<br/> • Documentation<br/> • Code/environment </FONT></TD></TR> </TABLE>>];
  ...
  subgraph cluster_summary {
    label=<<FONT POINT-SIZE='36'><B><BR/>Summary</B></FONT>>;
    style='filled,rounded';
    color='#FFF176';
    fillcolor='#FFF9C4';
    margin=30;
    ...
    results [fillcolor='#FFFDE7', label=< <TABLE BORDER='0' CELLBORDER='0' CELLSPACING='0' CELLPADDING='12'> <TR><TD ALIGN='CENTER'><B><FONT POINT-SIZE='24'>12. Results</FONT></B></TD></TR> <TR><TD ALIGN='LEFT' BALIGN='LEFT'><FONT POINT-SIZE='20'> • Best model<br/> • Key findings<br/> • Feature importance<br/> • Insights </FONT></TD></TR> </TABLE>>];
    limits [fillcolor='#FFFDE7', label=< <TABLE BORDER='0' CELLBORDER='0' CELLSPACING='0' CELLPADDING='12'> <TR><TD ALIGN='CENTER'><B><FONT POINT-SIZE='24'>13. Limitations</FONT></B></TD></TR> <TR><TD ALIGN='LEFT' BALIGN='LEFT'><FONT POINT-SIZE='20'> • Data sparsity<br/> • Model limits<br/> • Fairness<br/> • Recommendations </FONT></TD></TR> </TABLE>>];
    reproduc [fillcolor='#FFFDE7', label=< <TABLE BORDER='0' CELLBORDER='0' CELLSPACING='0' CELLPADDING='12'> <TR><TD ALIGN='CENTER'><B><FONT POINT-SIZE='24'>14. Reproducibility</FONT></B></TD></TR> <TR><TD ALIGN='LEFT' BALIGN='LEFT'><FONT POINT-SIZE='20'> • Environment<br/> • Data access<br/> • Requirements<br/> • Runtime </FONT></TD></TR> </TABLE>>];
    concl [fillcolor='#FFFDE7', label=< <TABLE BORDER='0' CELLBORDER='0' CELLSPACING='0' CELLPADDING='12'> <TR><TD ALIGN='CENTER'><B><FONT POINT-SIZE='24'>15. Conclusion</FONT></B></TD></TR> <TR><TD ALIGN='LEFT' BALIGN='LEFT'><FONT POINT-SIZE='20'> • Synthesis<br/> • Impact<br/> • Future work<br/> • Final thoughts </FONT></TD></TR> </TABLE>>];
