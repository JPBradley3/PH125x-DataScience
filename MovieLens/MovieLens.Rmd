...
```{r workflow, echo=FALSE, message=FALSE, warning=FALSE, out.width="100%", fig.cap="Project Workflow", fig.asp=1.3}
library(DiagrammeR)

# We removed the `size` attribute from the `graph` block below.
# This allows the diagram to scale naturally based on its content.
# The R chunk options `out.width` and `fig.asp` will now correctly
# control the final size in the document.
...
digraph pipeline {
  ...
  graph [
    ...
    rankdir=TB,
    bgcolor='white',
    nodesep=0.5,      # Increased space between nodes on the same rank
    ranksep=3,        # Increased vertical space between rows
    compound=true,
    pad=0.5           # Padding around the entire graph
    # CRITICAL: The 'size' attribute has been REMOVED.
  ]
  ...
  node [
    ...
    fontname='Arial',
    margin=0.25,      # More internal padding
    width=3.0,        # Wider boxes
    height=3.0,       # Taller boxes
    fontsize=20       # Larger base font for node titles
  ]
  
  # --- EDGE-LEVEL ATTRIBUTES ---
  edge [
    arrowsize=1.5,
    minlen=2          # Encourage longer edges
  ]
  
  # DATA AUDIT AND WRANGLING (Blue) - Top
  subgraph cluster_data {
    label=<<FONT POINT-SIZE='24'><B><BR/>Data Audit &amp; Wrangling</B></FONT>>
    style='filled,rounded'
    color='#81D4FA'
    fillcolor='#B3E5FC'
    fontcolor='black'
...
<FONT POINT-SIZE='18'>• Verify userId, movieId, rating<br ALIGN = 'LEFT' />
...
<FONT POINT-SIZE='18'>• Rating distribution<br ALIGN = 'LEFT' />
...
<FONT POINT-SIZE='18'>• Rating by genre/year<br ALIGN = 'LEFT' />
...
<FONT POINT-SIZE='18'>• Time features<br ALIGN = 'LEFT' />
...
• Tag outliers<br ALIGN = 'LEFT' /></FONT>>, fillcolor='#E1F5FE']
  ...
  subgraph cluster_modeling {
    label=<<FONT POINT-SIZE='24'><B><BR/>Model Development &amp; Evaluation</B></FONT>>
    style='filled,rounded'
    color='#9575CD'
    fillcolor='#D1C4E9'
    fontcolor='black'
...
<FONT POINT-SIZE='18'>• Identify ≥4 models<br ALIGN = 'LEFT' />
...
<FONT POINT-SIZE='18'>• Preprocessing<br ALIGN = 'LEFT' />
...
<FONT POINT-SIZE='18'>• Train models<br ALIGN = 'LEFT' />
...
<FONT POINT-SIZE='18'>• Avoid overfitting<br ALIGN = 'LEFT' />
...
<FONT POINT-SIZE='18'>• RMSE/MAE<br ALIGN = 'LEFT' />
...
<FONT POINT-SIZE='18'>• Stacking/blending<br ALIGN = 'LEFT' />
...
<FONT POINT-SIZE='18'>• Parameters<br ALIGN = 'LEFT' />
...
• Code/environment<br ALIGN = 'LEFT' /></FONT>>, fillcolor='#EDE7F6']
  ...
  subgraph cluster_summary {
    label=<<FONT POINT-SIZE='24'><B><BR/>Summary</B></FONT>>
    style='filled,rounded'
    color='#FFF176'
    fillcolor='#FFF9C4'
    fontcolor='black'
...
<FONT POINT-SIZE='18'>• Best model<br ALIGN = 'LEFT' />
...
<FONT POINT-SIZE='18'>• Data sparsity<br ALIGN = 'LEFT' />
...
<FONT POINT-SIZE='18'>• Environment<br ALIGN = 'LEFT' />
...
<FONT POINT-SIZE='18'>• Synthesis<br ALIGN = 'LEFT' />
