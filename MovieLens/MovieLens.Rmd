...
```{r ratings_summary, message=FALSE, warning=FALSE, results='asis', echo=FALSE}
...
```{r ratings_hist, message=FALSE, warning=FALSE, fig.width=5, fig.height=3, echo=FALSE}
...
skim_stats %>%
  ...
  knitr::kable(caption = "Summary statistics (mean, sd, median) for the movies data.")
```

```{r moviess_hist, message=FALSE, warning=FALSE, fig.width=5, fig.height=3, echo=FALSE}
ggplot(movie_counts, aes(x = num_ratings)) +
...
```{r movielens_hist, message=FALSE, warning=FALSE, fig.width=5, fig.height=3, echo=FALSE}
...
```{r make-pipeline-png, echo=FALSE, message=FALSE, warning=FALSE, eval=TRUE, out.width='100%', out.height='100%', dpi=1200}
