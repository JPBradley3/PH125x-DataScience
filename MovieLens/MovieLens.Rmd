...
digraph pipeline {
  ...
  subgraph cluster_data {
    label=<<FONT POINT-SIZE='22'><B>Data Audit &amp; Wrangling</B></FONT>>
    style='filled,rounded'
    color='#81D4FA'
    fillcolor='#B3E5FC'
    fontcolor='black'
    ...
    {
      rank=same;
      wrangling [label=<<B>Wrangling &amp; Cleaning</B><BR/>Parse vars, handle outliers,<BR/>clean dates, genres>, fillcolor='#E1F5FE']
      audit     [label=<<B>Bias Audit</B><BR/>Distribution checks,<BR/>groups>, fillcolor='#E1F5FE']
      trends    [label=<<B>Exploratory Trends</B><BR/>Year/genre/user<BR/>trends>, fillcolor='#E1F5FE']
      featprep  [label=<<B>Feature Prep</B><BR/>Encode/bins, normalize,<BR/>group>, fillcolor='#E1F5FE']
    }
  ...
  subgraph cluster_modeling {
    label=<<FONT POINT-SIZE='22'><B>Model Dev &amp; Evaluation</B></FONT>>
    style='filled,rounded'
    color='#9575CD'
    fillcolor='#D1C4E9'
    fontcolor='black'
    ...
    {
      rank=same;
      modelsel [label=<<B>Model Selection</B><BR/>Models, feature list,<BR/>assumptions>, fillcolor='#EDE7F6']
      prepfe  [label=<<B>Data Prep &amp; FE</B><BR/>Preprocessing, FE,<BR/>imbalance>, fillcolor='#EDE7F6']
      train   [label=<<B>Train &amp; Tune</B><BR/>Cross-validation,<BR/>logging>, fillcolor='#EDE7F6']
      reg     [label=<<B>Regularization</B><BR/>Penalty, effect<BR/>comparison>, fillcolor='#EDE7F6']
    }
    {
      rank=same;
      eval    [label=<<B>Evaluation</B><BR/>Metrics (RMSE, MAE),<BR/>tables>, fillcolor='#EDE7F6']
      ens     [label=<<B>Ensemble</B><BR/>Stack, blend,<BR/>trade-offs>, fillcolor='#EDE7F6']
      report  [label=<<B>Reporting &amp; Repro</B><BR/>Docs, visuals,<BR/>reproducibility>, fillcolor='#EDE7F6']
    }
  ...
  subgraph cluster_summary {
    label=<<FONT POINT-SIZE='22'><B>Summary</B></FONT>>
    style='filled,rounded'
    color='#FFF176'
    fillcolor='#FFF9C4'
    fontcolor='black'
    ...
    {
      rank=same;
      results [label=<<B>Results &amp; Interpretation</B><BR/>Findings,<BR/>metrics>, fillcolor='#FFFDE7']
      limits [label=<<B>Limitations &amp; Bias</B><BR/>Limits,<BR/>recs>, fillcolor='#FFFDE7']
      reproduc [label=<<B>Repro Appendix</B><BR/>Code, models,<BR/>data deps>, fillcolor='#FFFDE7']
      concl [label=<<B>Conclusion</B><BR/>Synthesis>, fillcolor='#FFFDE7']
    }
